...
otcdocs_repo_name = 'docs/data-admin-service'
...
otcdocs_doc_link = '/data-admin-service/api-ref/'
...
html_title = "Data Admin Service - API Reference"
...
latex_documents = [
    ('index',
     'das-api-ref.tex',
    u'Data Admin Service - API Reference',
